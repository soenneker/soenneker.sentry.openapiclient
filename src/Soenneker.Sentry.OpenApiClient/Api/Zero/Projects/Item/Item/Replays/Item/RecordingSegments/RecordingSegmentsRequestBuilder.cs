...
using Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.Item;
...
namespace Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments
{
    ...
    public partial class RecordingSegmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<UntypedNode?> GetAsync(Action<RequestConfiguration<global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder.RecordingSegmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UntypedNode> GetAsync(Action<RequestConfiguration<global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder.RecordingSegmentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder.RecordingSegmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder.RecordingSegmentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Return a collection of replay recording segments.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RecordingSegmentsRequestBuilderGetQueryParameters 
        {
