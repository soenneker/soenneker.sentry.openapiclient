...
namespace Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments
{
    ...
    public partial class RecordingSegmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public RecordingSegmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/replays/{replay_id}/recording-segments", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Replays.Item.RecordingSegments.RecordingSegmentsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordingSegmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/replays/{replay_id}/recording-segments", rawUrl)
        {
        }
    }
}
