...
namespace Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Releases.Item.Files
{
    ...
    public partial class FilesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Releases.Item.Files.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Releases.Item.Files.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public FilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/releases/{version}/files", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Api.Zero.Projects.Item.Item.Releases.Item.Files.FilesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/releases/{version}/files", rawUrl)
        {
        }
    }
}
