...
namespace Soenneker.Sentry.OpenApiClient.Api.Zero.Organizations.Item.Replays
{
    ...
    public partial class ReplaysRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Sentry.OpenApiClient.Api.Zero.Organizations.Item.Replays.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.Sentry.OpenApiClient.Api.Zero.Organizations.Item.Replays.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ReplaysRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/organizations/{organization_id_or_slug}/replays", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Api.Zero.Organizations.Item.Replays.ReplaysRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReplaysRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/0/organizations/{organization_id_or_slug}/replays", rawUrl)
        {
        }
    }
}
