...
namespace Soenneker.Sentry.OpenApiClient.Models
{
    ...
    public partial class Update_a_Monitor_by_ID : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_condition_group? ConditionGroup { get; set; }
#nullable restore
#else
        public global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_condition_group ConditionGroup { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_config? Config { get; set; }
#nullable restore
#else
        public global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_config Config { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_data_sources>? DataSources { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_data_sources> DataSources { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID"/> and sets the default values.
        /// </summary>
        public Update_a_Monitor_by_ID()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "condition_group", n => { ConditionGroup = n.GetObjectValue<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_condition_group>(global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_condition_group.CreateFromDiscriminatorValue); } },
                { "config", n => { Config = n.GetObjectValue<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_config>(global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_config.CreateFromDiscriminatorValue); } },
                { "data_sources", n => { DataSources = n.GetCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_data_sources>(global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_data_sources.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_condition_group>("condition_group", ConditionGroup);
            writer.WriteObjectValue<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_config>("config", Config);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.Update_a_Monitor_by_ID_data_sources>("data_sources", DataSources);
