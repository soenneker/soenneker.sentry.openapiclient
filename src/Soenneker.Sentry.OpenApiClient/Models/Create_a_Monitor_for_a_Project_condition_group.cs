...
namespace Soenneker.Sentry.OpenApiClient.Models
{
    ...
    public partial class Create_a_Monitor_for_a_Project_condition_group : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Models.Create_a_Monitor_for_a_Project_condition_group"/> and sets the default values.
        /// </summary>
        public Create_a_Monitor_for_a_Project_condition_group()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Sentry.OpenApiClient.Models.Create_a_Monitor_for_a_Project_condition_group"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Sentry.OpenApiClient.Models.Create_a_Monitor_for_a_Project_condition_group CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Sentry.OpenApiClient.Models.Create_a_Monitor_for_a_Project_condition_group();
        }
        /// <summary>
