...
namespace Soenneker.Sentry.OpenApiClient.Models
{
    ...
    public partial class DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actionMatch? ActionMatch { get; set; }
...
#nullable enable
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actions>? Actions { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actions> Actions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_conditions>? Conditions { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_conditions> Conditions { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filterMatch? FilterMatch { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filters>? Filters { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filters> Filters { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project"/> and sets the default values.
        /// </summary>
        public DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "actionMatch", n => { ActionMatch = n.GetEnumValue<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actionMatch>(); } },
                { "actions", n => { Actions = n.GetCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actions>(global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actions.CreateFromDiscriminatorValue)?.AsList(); } },
                { "conditions", n => { Conditions = n.GetCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_conditions>(global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_conditions.CreateFromDiscriminatorValue)?.AsList(); } },
                { "environment", n => { Environment = n.GetStringValue(); } },
                { "filterMatch", n => { FilterMatch = n.GetEnumValue<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filterMatch>(); } },
                { "filters", n => { Filters = n.GetCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filters>(global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filters.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actionMatch>("actionMatch", ActionMatch);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_actions>("actions", Actions);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_conditions>("conditions", Conditions);
            writer.WriteStringValue("environment", Environment);
            writer.WriteEnumValue<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filterMatch>("filterMatch", FilterMatch);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Sentry.OpenApiClient.Models.DEPRECATED_Create_an_Issue_Alert_Rule_for_a_Project_filters>("filters", Filters);
